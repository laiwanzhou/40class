...
| Phase 4: Train-14 OOF scientific evaluation | In progress | `335f5e2` | Step 1 inputs, strict-v2 OOF protocol, canonical seed, write-once three-fold assignment, and usable-IR inner coverage are frozen | The first seed run was aborted before refit after detecting a scheduler-horizon mismatch; held-out labels remain sealed | Restart seed `20260715` under the frozen strict-v2 run ID |
