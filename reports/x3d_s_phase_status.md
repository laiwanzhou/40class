...
| Phase 4: Train-14 OOF scientific evaluation | In progress | `b95e18f` | Step 1 inputs, strict scheduler and equal-trial accumulation protocols, canonical seed, write-once three-fold assignment, and usable-IR inner coverage are frozen | Earlier runs were aborted before refit; held-out labels remain sealed | Restart seed `20260715` under the frozen strict-v3 run ID |
