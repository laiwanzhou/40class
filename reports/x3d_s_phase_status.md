...
| Phase 3: End-to-end verification | In progress | - | Real manifest, CUDA smoke, 16-trial overfit and size/fusion audit pass; evidence-based parity contract revision approved | Revised six-trial input-parity and fixed-checkpoint sensitivity audits have not yet been rerun | Rerun Step 6 under the frozen multi-metric contract before Step 7 |
