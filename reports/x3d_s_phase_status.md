...
| Phase 4: Train-14 OOF scientific evaluation | In progress | `74c679a` + scheduler amendment pending commit | Step 1 inputs, strict OOF protocol, canonical seed, write-once three-fold assignment, and usable-IR inner coverage are frozen | The first seed run was aborted before refit after detecting a scheduler-horizon mismatch; held-out labels remain sealed | Commit/push the strict-v2 protocol, then restart seed `20260715` under a new run ID |
