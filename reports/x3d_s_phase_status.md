...
| Phase 4: Train-14 OOF scientific evaluation | In progress | `43e6c3e` + trial-weighting fix pending | Step 1 inputs, strict scheduler protocol, canonical seed, write-once three-fold assignment, and usable-IR inner coverage are frozen | A later run was aborted before refit after detecting duration-dependent trial weighting in gradient accumulation; held-out labels remain sealed | Verify and pre-register equal-trial accumulation, then restart seed `20260715` under strict-v3 |
