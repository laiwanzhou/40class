...
| Phase 5: Register IR sparse evidence | Completed | pending closure commit | Canonical 2,320-row OOF and physically label-free 590-row held-out archives registered as `ir_x3d_s_k400_pure`; train-14 finalization used frozen seed 20260715 and 11 epochs | Held-out archive remains evaluation-only and quarantined until Phase 10; `>64` OOF bucket remains weak | Stop this branch for Phase 5 review |
